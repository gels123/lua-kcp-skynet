...
static int l_isleep(lua_State* L)
{
...
static int l_netbytes2uint32(lua_State* L){
...
static int l_uint322netbytes(lua_State* L){
...
int luaopen_lutil(lua_State *L) {
    luaL_Reg libs[] = {
        ...
        {"isleep", l_isleep},
        {"netbytes2uint32", l_netbytes2uint32},
        {"uint322netbytes", l_uint322netbytes},
        {NULL, NULL},
    };
    luaL_newlib(L, libs);
    return 1;
